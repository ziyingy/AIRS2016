...
103 runs and 50 topics, 103 points plotted
...
variance.}}
{\alicia{Have updated the graphs, not sure if we need RBP(p=0.6). Caption need to be updated...}}
