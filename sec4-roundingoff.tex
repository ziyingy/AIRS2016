...
(left) and $95$\% (right) of the original run score.
{\alistair{Table needs to be update to $80$ systems rather than $75$,
needs RHS filled in.}}
...
{\alistair{RHS shows similar, with $95$\% ratio.}}
...
\alistair{Temporary figure, one frame stolen out of Andrew's PDF
file, still using the old 75 runs, not the new 80 systems.}
