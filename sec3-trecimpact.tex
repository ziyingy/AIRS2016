...
below.
{\alistair{Change graph to match statement.
Make sure that points on edge don't get clipped.
Make main axis lines darker.
Increase fonts in legend and make it in to two columns to take less
